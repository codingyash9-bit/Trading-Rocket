...
app.include_router(realtime_router, prefix="/api", tags=["Real-Time Market"])
app.include_router(analyze_router, prefix="/api", tags=["Analyze"])
app.include_router(chat_router, prefix="/api", tags=["Chat"])
app.include_router(simulate_router, prefix="/api", tags=["Simulate"])
app.include_router(news_router, prefix="/api", tags=["News"])
app.include_router(portfolio_router, prefix="/api", tags=["Paper Portfolio"])
app.include_router(radar_router, prefix="/api", tags=["Company Radar"])
app.include_router(pulse_router, prefix="/api", tags=["Market Pulse"])
app.include_router(user_router, prefix="/api/user", tags=["User Settings"])
app.include_router(autopsy_router, prefix="/api", tags=["Autopsy"])
app.include_router(predictions_router, prefix="/api", tags=["Predictions"])
app.include_router(outcomes_router, prefix="/api", tags=["Outcomes"])
app.include_router(bias_router, prefix="/api", tags=["Bias"])
app.include_router(wargame_router, prefix="/api", tags=["Wargame"])
app.include_router(graveyard_router, prefix="/api", tags=["Graveyard"])
